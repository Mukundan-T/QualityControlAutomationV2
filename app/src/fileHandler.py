...
def write_excelfile(ExcelFile):
    ...
    reset_colors(ExcelFile, wb,  ExcelFile.cachedColors.copy.update(ExcelFile.failColors)) # Only removes fail colors since this is independent of spreadsheetChecks
